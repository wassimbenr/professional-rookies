...
void afficher_background(background *b, SDL_Surface *screen)
{
	...
	SDL_BlitSurface(b->image, &b->posCamera, screen,&b->position_background_mask); //&b->position_background

	SDL_BlitSurface(b->background_mask, &b->posCamera, screen,&b->position_background);
}
